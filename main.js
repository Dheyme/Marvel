function character() {
    ...
    if (queryParameterName !== null && queryParameterName !== "") {
      ...
      document.getElementById("characterSection").innerHTML =
        '<h2 id="characterMainTitle">Insira o termo da pesquisa acima...</h2>';
    }
  }
  ...
  function connection() {
    ...
    xhr.onerror = function() {
      document.getElementById("characterSection").innerHTML = '<h2 id="characterMainTitle">Ocorreu um erro, verifique sua conexão.</h2>';
    }
    ...
    xhr.onload = function() {
      if (this.status == 200) {
        ...
        document.getElementById("characterSection").innerHTML = '<h2 id="characterMainTitle">Pedido não recebido</h2>';
      }
    }
  ...
  function character() {
    ...
    if (queryParameterName !== null && queryParameterName !== "") {
      ...
      document.getElementById("characterSection").innerHTML =
        '<h2 id="characterMainTitle">Insira o termo de pesquisa acima...</h2>';
    }
  }
  ...
  function connection() {
    ...
    xhr.onerror = function() {
      document.getElementById("characterSection").innerHTML = '<h2 id="characterMainTitle">Ocorreu um erro, verifique a conexão.</h2>';
    }
    xhr.onload = function() {
      if (this.status == 200) {
        const results = JSON.parse(this.responseText);
        ...
        if (results["data"].count === 0) {
          document.getElementById("characterSection").innerHTML =
            '<h2 id="characterMainTitle"><span style="font-weight:bold;">Sem resultados para... ' +
            name + "</span>" + ". Tente novamente.</h2>";
          ...
          document.getElementById("characterSection").innerHTML =
            ...
            "An error might have occured on our end, Sorry. <br>Nesse caso, tente novamente depois.</h2>";
        ...
        document.getElementById("characterSection").innerHTML = '<h2 id="characterMainTitle">Requisição não recebida</h2>';
      }
    }
    xhr.onloadend = function() {
      document.getElementById("characterSpinnerSection").innerHTML = "";
